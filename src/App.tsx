    ...
    <div className="gold-panel honeycomb-bg rounded-[28px] p-6 text-white w-full max-w-[320px] shadow-2xl shadow-[#E9B84A33]">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        {["Netflix", "Spotify", "DSTV", "Gym"].map((s) => (
          <span
            key={s}
            className="bg-white/20 backdrop-blur-sm text-[11px] px-3 py-1 rounded-full font-medium"
          >
            {s}
          </span>
        ))}
...
function SideNav({
  ...
  return (
    <div
      className={`fixed right-6 md:right-8 top-1/2 -translate-y-1/2 z-50 hidden md:flex flex-col items-center h-[320px] justify-between py-4 transition-all duration-500 ease-in-out ${
        isVisible
...
export default function App() {
  ...
  const slides = [
      ...
      <div className="max-w-6xl w-full grid md:grid-cols-2 gap-8 lg:gap-16 items-center relative z-10">
        ...
        <div>
          ...
          <h1 className="text-4xl sm:text-5xl md:text-5xl lg:text-6xl font-black leading-[1.1] md:leading-[1.05] tracking-tight text-[#1E2A2E] mb-6">
            Netflix shouldn't have access to your{" "}
            <span className="underline-gold">rent money</span>.
          </h1>

          <p className="text-base sm:text-lg text-[#1E2A2E]/60 leading-relaxed max-w-md mb-8">
            Stop linking your main bank account to the internet. Fund your
            SubBee wallet once a month, and we'll pay your subscriptions using a
            virtual card that can't be overdrawn.
          </p>
    ...
    >
      ...
      <div className="max-w-4xl w-full relative z-20">
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-[#1E2A2E] leading-tight text-center mb-8 md:mb-6">
          ...
          {[
            {
              ...
              body: "Wire your monthly subscription budget to your dedicated Nomba account.",
              visual: (
                <div className="flex items-center gap-2 mb-4">
                  <img
                    src="/assets/nomba-transparent.png"
                    alt="Nomba"
            ...
            {
              n: "2",
              head: "List your bills",
              body: "Tell us you pay Netflix ₦4,900 and DSTV ₦13,000. Or don't, Subee can figure it out!",
              visual: (
                <div className="flex gap-[-8px] mb-4">
                  <img
                    src="/assets/netflix.png"
                    alt="Netflix"
                    className="h-10 w-10 rounded-full border-2 border-white shadow-sm -ml-0"
                  />
                  <img
                    src="/assets/spotify.png"
                    alt="Spotify"
                    className="h-10 w-10 rounded-full border-2 border-white shadow-sm -ml-3"
                  />
                  <img
                    src="/assets/dstv.png"
                    alt="DSTV"
            ...
            },
            {
              ...
              body: "We hand you a virtual Mastercard that stays empty by default.",
              visual: (
                <div className="mb-3 scale-[0.55] origin-top-right -mt-2 h-[100px]">
                  <BeeCard />
                </div>
              ),
            },
            {
              n: "4",
              head: "Approve via Telegram or WhatsApp",
              body: "We ping you 3 days before a bill. Say yes, and we fund the card for that exact millisecond.",
              visual: (
                <img
                  src="/assets/alerts_postman.png"
                  alt="Telegram"
                  className="h-28 object-contain object-left mb-3"
                />
              ),
            },
            ...
            <div
              key={n}
              className="relative bg-white border border-gray-100 rounded-2xl p-5 shadow-sm overflow-hidden hover:shadow-md transition-shadow"
            >
              <span className="step-num">{n}</span>
              <div className="relative flex flex-col justify-between h-full z-10 pl-10">
                {visual}
                <div>
                  <p className="font-black text-xl text-[#1E2A2E] mb-2">
                    {head}
                  </p>
                  <p className="text-[#1E2A2E]/60 text-sm leading-relaxed">
                    {body}
                  </p>
                </div>
              </div>
    ...
    >
      <div className="max-w-4xl w-full relative z-10 flex flex-col items-center text-center">
        ...
        <div className="relative z-20 mb-6">
          <p className="text-[#E9B84A] text-sm font-bold uppercase tracking-widest mb-3">
            Flexibility
          </p>
        ...
        <div className="relative z-20 bg-[#0E2426] p-1.5 rounded-full flex items-center mb-8 shadow-inner border border-white/5">
          <button
            ...
            className={`relative px-6 py-3 rounded-full text-sm font-bold transition-all duration-300 ${
              !isAutoPilot
                ? "text-[#1E2A2E] shadow-md"
                : "text-white/50 hover:text-white/80"
            }`}
          >
            {!isAutoPilot && (
              <div className="absolute inset-0 bg-white rounded-full z-0 transition-all duration-300"></div>
            )}
          ...
          <button
            ...
            className={`relative px-6 py-3 rounded-full text-sm font-bold transition-all duration-300 ${
              isAutoPilot
                ? "text-[#1E2A2E] shadow-md shadow-[#E9B84A]/20"
                : "text-white/50 hover:text-white/80"
            }`}
          >
            {isAutoPilot && (
              <div className="absolute inset-0 bg-[#E9B84A] rounded-full z-0 transition-all duration-300"></div>
            )}
        ...
        <div className="relative z-20 min-h-[220px] transition-opacity duration-300 flex flex-col items-center">
          {isAutoPilot ? (
            <div key="auto" className="slide-up">
              ...
              <ul className="text-left inline-block space-y-4 text-white/80 text-lg">
                <li className="flex items-center gap-3">
                  <span className="text-[#E9B84A] text-xl">💰</span> Fund your
                  wallet on payday. Go to sleep.
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-[#E9B84A] text-xl">🔍</span> We detect
                  every subscription.
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-[#E9B84A] text-xl">⚡</span> We pay them
                  exactly on time and send a receipt.
                </li>
              </ul>
            </div>
          ) : (
            <div key="manual" className="slide-up">
              ...
              <ul className="text-left inline-block space-y-4 text-white/80 text-lg">
                <li className="flex items-center gap-3">
                  <span className="text-white text-xl">🎯</span> Don't trust
                  automation? No problem.
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-white text-xl">🛑</span> Fund exact
                  amounts for specific bills only.
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-white text-xl">📅</span> If Spotify is
                  ₦1,200, put exactly ₦1,200 on the card.
                </li>
              </ul>
            </div>
          )}
      ...
      <div className="max-w-5xl w-full grid md:grid-cols-2 gap-8 lg:gap-16 items-center">
        <div>
          ...
          <h2 className="text-3xl sm:text-5xl md:text-5xl lg:text-6xl font-black leading-tight mb-6">
            Hackers can't
            <br />
            steal <span className="text-[#E9B84A] text-tabular">₦ 0.00</span>.
          </h2>
          <p className="text-white/60 text-lg leading-relaxed max-w-sm mb-6">
            We keep your virtual card empty. We only move cash to it
            milliseconds before a verified charge hits. If a scammer gets your
            card details, they get a piece of plastic with zero purchasing
            power.
          </p>
    ...
    >
      <div className="max-w-5xl w-full grid md:grid-cols-2 gap-8 lg:gap-16 items-center">
        ...
        <div className="order-2 md:order-1 flex justify-center relative">
          ...
          <div className="bg-[#17212b] rounded-3xl p-5 w-full max-w-[300px] shadow-2xl shadow-[#17212b]/30 relative z-10">
            ...
            <div className="bg-[#2b5278] rounded-2xl rounded-tl-none px-4 py-3 mb-3">
              <p className="text-white text-sm leading-relaxed">
                🐝 Heads up! Your <strong>Spotify</strong> (₦1,200) charges in{" "}
            ...
            <div className="flex gap-2">
              {["Pay now", "Skip", "Pause"].map((a) => (
                <button
                  key={a}
                  className="flex-1 bg-white/10 hover:bg-white/20 text-white text-xs py-2 rounded-xl font-medium transition-colors"
                >
                  {a}
                </button>
              ))}
          ...
          <img
            src="/assets/bee-waiting.png"
            alt=""
            className="h-20 scale-x-[-1] opacity-80"
          />
        </div>
    ...
    >
      ...
      <div className="max-w-4xl w-full text-center relative z-10">
        ...
        <p className="text-white/30 text-xs mt-6">
          No paperwork. No BVN delays. Just your phone number.
        </p>
      </div>
    </Slide>,
  ];
  ...
  return (
    <div className="relative">
      ...
      {/* Slides */}
      <main className="relative z-10">{slides}</main>
    </div>
  );
}
